...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      */
    ...
    }, { "./is-object": 18, "./request": 20, "./request-base": 19, "emitter": 3 }], 18: [function (require, module, exports) {
      /**
    ...
    }, { "./formdata.js": 23, "./index.js": 24, "./localstorage.js": 25, "./websocket.js": 26, "./xmlhttprequest.js": 27 }], 23: [function (require, module, exports) {
    ...
    }, { "./formdata.js": 23, "./localstorage.js": 25, "./websocket.js": 26, "./xmlhttprequest.js": 27 }], 25: [function (require, module, exports) {
    ...
    }, { "event-target-shim": 9 }], 27: [function (require, module, exports) {
      var EventTarget = require('event-target-shim');
      var FormData = require('./formdata.js');
          ...
          value: function send(data) {
            ...
            if (data instanceof FormData) {
              ...
              var restData = entries.filter(function (entry) {
                ...
                return Object.assign(result, _defineProperty2({}, entry[0], entry[1]));
              }, {});
              wx.uploadFile({
                url: this._url,
                name: blobs[0][0],
    ...
    }, { "./formdata.js": 23, "event-target-shim": 9 }], 28: [function (require, module, exports) {
    ...
    }, { "./utils": 57, "_process": 15, "underscore": 21 }], 30: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
    ...
    }, { "../promise": 45, "localstorage-memory": 12, "react-native": 1, "underscore": 21 }], 31: [function (require, module, exports) {
    ...
    }, { "./av": 29, "./localstorage": 42 }], 33: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./request": 49, "underscore": 21 }], 34: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 36: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
    ...
    }, { "./browserify-wrapper/parse-base64": 31, "./error": 34, "./promise": 45, "./request": 49, "./uploader/cos": 53, "./uploader/qiniu": 54, "./uploader/s3": 55, "underscore": 21 }], 37: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 38: [function (require, module, exports) {
      require('weapp-polyfill/auto-polyfill');

      module.exports = require('./index');
    }, { "./index": 39, "weapp-polyfill/auto-polyfill": 22 }], 39: [function (require, module, exports) {
      /*!
       ...
       */
    }, { "./acl": 28, "./av": 29, "./cache": 32, "./cloudfunction": 33, "./error": 34, "./event": 35, "./file": 36, "./geopoint": 37, "./init": 40, "./insight": 41, "./localstorage": 42, "./object": 43, "./op": 44, "./promise": 45, "./push": 46, "./query": 47, "./relation": 48, "./role": 50, "./search": 51, "./status": 52, "./user": 56, "./version": 58, "underscore": 21 }], 40: [function (require, module, exports) {
      var AV = require('./av');
    ...
    }, { "./av": 29, "./request": 49 }], 41: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 34, "./request": 49, "underscore": 21 }], 42: [function (require, module, exports) {
      var _ = require('underscore');
      var Promise = require('./promise');
    ...
    }, { "./browserify-wrapper/localStorage": 30, "./promise": 45, "underscore": 21 }], 43: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 34, "./request": 49, "./utils": 57, "underscore": 21 }], 44: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "rsvp": 16, "underscore": 21 }], 46: [function (require, module, exports) {
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 49 }], 47: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 34, "./request": 49, "./utils": 57, "underscore": 21 }], 48: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 49: [function (require, module, exports) {
      (function (process) {
    ...
    }, { "./av": 29, "./cache": 32, "./error": 34, "./promise": 45, "./utils": 57, "_process": 15, "debug": 5, "md5": 13, "superagent": 17, "underscore": 21 }], 50: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
    ...
    }, { "./error": 34, "underscore": 21 }], 51: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 49, "underscore": 21 }], 52: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
        ...
        AV.Status.prototype = {
          ...
          send: function send() {
            ...
            return getUserPointer(options).then(function (currUser) {
              var query = _this7.query.toJSON();
              query.className = _this7.query.className;
              var data = {};
              data.query = query;
              _this7.data = _this7.data || {};
              _this7.data.source = _this7.data.source || currUser;
              data.data = _this7._getDataJSON();
              data.inboxType = _this7.inboxType || 'default';

              return AVRequest('statuses', null, null, 'POST', data, options.sessionToken);
            }).then(function (response) {
              _this7.id = response.objectId;
              _this7.createdAt = AV._parseDate(response.createdAt);
              return _this7;
            });
          },
    ...
    }, { "./request": 49, "underscore": 21 }], 53: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 45, "debug": 5, "superagent": 17 }], 54: [function (require, module, exports) {
      var request = require('superagent');
      var Promise = require('../promise');
    ...
    }, { "../promise": 45, "debug": 5, "superagent": 17 }], 55: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 45, "superagent": 17 }], 56: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
        ...
        AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
          ...
          _linkWith: function _linkWith(provider, data) {
            ...
            if (data) {
              ...
              return provider.authenticate().then(function (result) {
                return _this8._linkWith(provider, result);
              });
            }
          },
          ...
          _unlinkFrom: function _unlinkFrom(provider) {
            ...
            return this._linkWith(provider, null).then(function (model) {
              _this9._synchronizeAuthData(provider);
              return model;
            });
          },
