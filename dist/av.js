...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      */
    ...
    }, { "./is-object": 14, "./request": 16, "./request-base": 15, "emitter": 3 }], 14: [function (require, module, exports) {
      /**
    ...
    }, { "./utils": 46, "_process": 11, "underscore": 17 }], 20: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
    ...
    }, { "../promise": 34, "localstorage-memory": 8, "react-native": 1, "underscore": 17 }], 21: [function (require, module, exports) {
    ...
    }, { "./av": 19, "./localstorage": 31 }], 23: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./request": 38, "underscore": 17 }], 24: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./browserify-wrapper/parse-base64": 21, "./error": 24, "./promise": 34, "./request": 38, "./uploader/cos": 42, "./uploader/qiniu": 43, "./uploader/s3": 44, "underscore": 17 }], 27: [function (require, module, exports) {
      var _ = require('underscore');
       ...
       */
    }, { "./acl": 18, "./av": 19, "./cache": 22, "./cloudfunction": 23, "./error": 24, "./event": 25, "./file": 26, "./geopoint": 27, "./init": 29, "./insight": 30, "./localstorage": 31, "./object": 32, "./op": 33, "./promise": 34, "./push": 35, "./query": 36, "./relation": 37, "./role": 39, "./search": 40, "./status": 41, "./user": 45, "./version": 47, "underscore": 17 }], 29: [function (require, module, exports) {
      var AV = require('./av');
    ...
    }, { "./av": 19, "./request": 38 }], 30: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 24, "./request": 38, "underscore": 17 }], 31: [function (require, module, exports) {
      var _ = require('underscore');
      var Promise = require('./promise');
    ...
    }, { "./browserify-wrapper/localStorage": 20, "./promise": 34, "underscore": 17 }], 32: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 24, "./request": 38, "./utils": 46, "underscore": 17 }], 33: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 17 }], 34: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "rsvp": 12, "underscore": 17 }], 35: [function (require, module, exports) {
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 24, "./request": 38, "./utils": 46, "underscore": 17 }], 37: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./av": 19, "./cache": 22, "./error": 24, "./promise": 34, "./utils": 46, "_process": 11, "debug": 5, "md5": 9, "superagent": 13, "underscore": 17 }], 39: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
    ...
    }, { "./error": 24, "underscore": 17 }], 40: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 38, "underscore": 17 }], 41: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
        ...
        AV.Status.prototype = {
          ...
          send: function send() {
            ...
            return getUserPointer(options).then(function (currUser) {
              var query = _this4.query.toJSON();
              query.className = _this4.query.className;
              var data = {};
              data.query = query;
              _this4.data = _this4.data || {};
              _this4.data.source = _this4.data.source || currUser;
              data.data = _this4._getDataJSON();
              data.inboxType = _this4.inboxType || 'default';

              return AVRequest('statuses', null, null, 'POST', data, options.sessionToken);
            }).then(function (response) {
              _this4.id = response.objectId;
              _this4.createdAt = AV._parseDate(response.createdAt);
              return _this4;
            });
          },
    ...
    }, { "./request": 38, "underscore": 17 }], 42: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 34, "debug": 5, "superagent": 13 }], 43: [function (require, module, exports) {
      var request = require('superagent');
      var Promise = require('../promise');
    ...
    }, { "../promise": 34, "debug": 5, "superagent": 13 }], 44: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 34, "superagent": 13 }], 45: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
        ...
        AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
          ...
          _linkWith: function _linkWith(provider, data) {
            ...
            if (data) {
              ...
              return provider.authenticate().then(function (result) {
                return _this5._linkWith(provider, result);
              });
            }
          },
          ...
          _unlinkFrom: function _unlinkFrom(provider) {
            ...
            return this._linkWith(provider, null).then(function (model) {
              _this6._synchronizeAuthData(provider);
              return model;
            });
          },
    ...
    }, { "./error": 24, "./request": 38, "underscore": 17 }], 46: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 17 }], 47: [function (require, module, exports) {
